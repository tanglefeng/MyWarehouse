...
namespace Kengic.Was.CrossCutting.LinqToWcf.Expressions.Helpers
{
    ...
    public class RewriteExpressionVisitor : ExpressionVisitor
    {
        ...
        protected Expression VisitExpression(Expression expression) => Visit<Expression>(expression);
        ...
        protected override object VisitBinaryExpression(BinaryExpression expression)
            => Expression.MakeBinary(expression.NodeType, VisitExpression(expression.Left),
                VisitExpression(expression.Right), expression.IsLiftedToNull, expression.Method);
        ...
        protected override object VisitConditionalExpression(ConditionalExpression expression)
            => Expression.Condition(VisitExpression(expression.Test), VisitExpression(expression.IfTrue),
        ...
        protected override object VisitTypedExpression<T>(Expression<T> expression)
            => Expression.Lambda<T>(VisitExpression(expression.Body),
                VisitCollection<ParameterExpression>(expression.Parameters));
        ...
        protected override object VisitInvocationExpression(InvocationExpression expression)
            => Expression.Invoke(VisitExpression(expression.Expression),
        ...
        protected override object VisitLambdaExpression(LambdaExpression expression)
            => Expression.Lambda(expression.Type, VisitExpression(expression.Body),
                VisitCollection<ParameterExpression>(expression.Parameters));
        ...
        protected override object VisitListInitExpression(ListInitExpression expression)
            => Expression.ListInit(Visit<NewExpression>(expression.NewExpression),
        ...
        protected override object VisitMemberExpression(MemberExpression expression)
            => Expression.MakeMemberAccess(VisitExpression(expression.Expression), expression.Member);
        ...
        protected override object VisitMemberInitExpression(MemberInitExpression expression)
            => Expression.MemberInit(Visit<NewExpression>(expression.NewExpression),
                VisitObjectCollection<MemberBinding>(expression.Bindings));
        ...
        protected override object VisitMethodCallExpression(MethodCallExpression expression)
            => Expression.Call(VisitExpression(expression.Object), expression.Method,
                VisitCollection<Expression>(expression.Arguments));
        ...
        protected override object VisitParameterExpression(ParameterExpression expression)
            => Expression.Parameter(expression.Type, expression.Name);
        ...
        protected override object VisitTypeBinaryExpression(TypeBinaryExpression expression)
            => Expression.TypeIs(VisitExpression(expression.Expression), expression.TypeOperand);
        ...
        protected override object VisitUnaryExpression(UnaryExpression expression)
            => Expression.MakeUnary(expression.NodeType, VisitExpression(expression.Operand), expression.Type,
                expression.Method);
        ...
        protected override object VisitElementInit(ElementInit elementInit)
            => Expression.ElementInit(elementInit.AddMethod, VisitCollection<Expression>(elementInit.Arguments));
        ...
        protected override object VisitMemberAssignment(MemberAssignment memberAssignment)
            => Expression.Bind(memberAssignment.Member, VisitExpression(memberAssignment.Expression));
        ...
        protected override object VisitMemberMemberBinding(MemberMemberBinding memberMemberBinding)
            => Expression.MemberBind(memberMemberBinding.Member,
