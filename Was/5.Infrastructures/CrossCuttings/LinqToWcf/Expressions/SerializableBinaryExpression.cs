        ...
        private string GetOperator()
        {
            switch (NodeType)
            {
                ...
                case ExpressionType.And:
                    if ((Type != InterLinqTypeSystem.Instance.GetInterLinqVersionOf<InterLinqType>(typeof (bool))) &&
                        (Type != InterLinqTypeSystem.Instance.GetInterLinqVersionOf<InterLinqType>(typeof (bool?))))
