...
namespace Kengic.Was.CrossCutting.LinqToWcf.Expressions
{
    ...
    public static class ExpressionConversionHelper
    {
        ...
        public static T MakeSerializable<T>(this Expression exp, ExpressionConverter expConverter)
            where T : SerializableExpression => expConverter.Convert<T>(exp);
        ...
        public static Collection<T> MakeSerializableCollection<T>(this IEnumerable exp, ExpressionConverter expConverter)
            where T : SerializableExpression => expConverter.ConvertCollection<T>(exp);
        ...
        public static object Convert(this SerializableExpression exp, IQueryHandler linqHandler)
            => new SerializableExpressionConverter(exp, linqHandler).Visit();
    }
}