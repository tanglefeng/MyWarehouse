...
namespace Kengic.Was.CrossCutting.LinqToWcf.Expressions
{
    ...
    public class SerializableNewExpression : SerializableExpression
    {
            ...
            : base(expression, expConverter)
        {
            ...
            Constructor =
                InterLinqTypeSystem.Instance.GetInterLinqVersionOf<InterLinqConstructorInfo>(expression.Constructor);
        }
        ...
        internal override void BuildString(StringBuilder builder)
        {
            ...
            var type = Constructor == null ? Type : Constructor.DeclaringType;
            builder.Append("new ");
                ...
                for (var i = 0; i < count; i++)
                {
                    ...
                    if (Members != null)
                    {
                        ...
                        if ((Members[i].MemberType == MemberTypes.Method) &&
                            ((propertyName = GetPropertyNoThrow((InterLinqMethodInfo) Members[i])) != null))
                        {
