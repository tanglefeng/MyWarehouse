...
namespace Kengic.Was.CrossCutting.LinqToWcf
{
    ...
    public interface IQueryHandler
    {
        ...
        IQueryable Get(Type type, object additionalObject, string queryName, object sessionObject,
        ...
        IQueryable<T> Get<T>(object additionalObject, string queryName, object sessionObject, params object[] parameters)
            where T : class;
