...
namespace Kengic.Was.CrossCutting.LinqToWcf
{
    ...
    public abstract class InterLinqQueryHandler : IQueryHandler
    {
        ...
        private readonly Dictionary<Type, MethodInfo> genericMethodsCache1 = new Dictionary<Type, MethodInfo>();

        private readonly Dictionary<Type, MethodInfo> genericMethodsCache2 = new Dictionary<Type, MethodInfo>();
        ...
        public virtual IQueryable Get(Type type, object additionalObject, string name, object sessionObject,
            params object[] parameters)
        {
            ...
            return
                (IQueryable)
                    genericGetTableMethod.Invoke(this, new[] {additionalObject, name, sessionObject, parameters});
        }
        ...
        /// <param name="parameters">Parameters for the quey.</param>
        /// <returns>Returns a <see cref="IQueryable{T}" />.</returns>
        public virtual IQueryable<T> Get<T>(object additionalObject, string name, object sessionObject,
